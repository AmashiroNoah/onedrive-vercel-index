...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'kivotos@kivotos.ltd',
  ...
  email: 'mailto:kivotos@kivotos.ltd',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/KivotosLibraryTeam/',
    },
  ],
